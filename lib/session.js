(function() {
  ...
  Session = (function(superClass) {
    ...
    function Session(socket, supportedRoles, authConfig) {
      if (authConfig == null) {
        authConfig = null;
      }
      ...
      this.authenticator = Authenticator(this, authConfig);
            ...
            case 'HELLO':
              ...
              if (_this.authenticator == null) {
                return q.fcall(function() {
                  ...
                  return logger.debug('attached session to realm', message.realm);
                })["catch"](function(err) {
              ...
              break;
            case 'AUTHENTICATE':
              return (ref = _this.authenticator) != null ? ref.authenticate(message).then(function(user) {
