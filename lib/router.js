(function() {
  ...
  Router = (function(superClass) {
    ...
    function Router(opts) {
      ...
      _.forEach(this.config.getValue('realms'), (function(_this) {
        return function(values, realm) {
          return _this.createRealm(realm);
        };
      })(this));
      ...
      this.on('connection', (function(_this) {
        return function(socket) {
          var ref, ref1, session;
          logger.info('incoming socket connection');
          session = new Session(socket, _this.roles, (ref = _this.config.getValue('auth')) != null ? ref : null, (ref1 = _this.config.getValue('realms')) != null ? ref1 : null);
