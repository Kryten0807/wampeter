(function() {
  var BASE_URI, CLEANUP_DELAY, CLogger, D, INVALID_AUTHID, INVALID_KEY, PORT, REALM_URI, ROUTER_CONFIG, URL, VALID_AUTHID, VALID_KEY, authenticator, autobahn, chai, expect, logger, obj, promised, spies, wampeter;
